...
string ManagerImpl::SendToManager(string message)
{
	if(verbose) {
...
void ManagerImpl::AddPort(string port, string password)
{
...
void ManagerImpl::DeletePort(string port)
{
	db_.DeletePort(port);
...
vector<traffic> ManagerImpl::GetTrafficData()
{
	vector<traffic> ret;
...
string ManagerImpl::GetTrafficString()
{
...
string ManagerImpl::HandleCmd(const string& msg)
{
	string ret;
